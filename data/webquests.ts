...
export const webQuests: WebQuest[] = [
  {
    id: 1,
    title: "M1: Guardianes de Kodu 3D",
    description: "Iniciación en la creación de terrenos y lógica visual When-Do.",
    platform: Platform.KODU,
    imageUrl: "https://www.microsoft.com/en-us/research/wp-content/uploads/2016/06/Kodu-Game-Lab.png",
  ...
  {
    id: 2,
    title: "M2: Algoritmos con CodeSpark",
    description: "Aprende a pensar en pasos ordenados para resolver puzzles.",
    platform: Platform.CODESPARK,
    imageUrl: "https://static.cdn.codespark.com/images/codespark-academy-the-foos-logo.png",
  ...
  {
    id: 3,
    title: "M3: Agentes en Minecraft Edu",
    description: "Usa el agente para construir estructuras automáticamente.",
    platform: Platform.MINECRAFT,
    imageUrl: "https://education.minecraft.net/wp-content/uploads/minecraft-education-agent.jpg",
  ...
  {
    id: 4,
    title: "M4: Bucles Espaciales con Kodable",
    description: "Optimiza tu código usando repeticiones infinitas.",
    platform: Platform.KODABLE,
    imageUrl: "https://www.kodable.com/static/kodable-og-image.png",
  ...
  {
    id: 5,
    title: "M5: Sensores en Kodu",
    description: "Haz que los objetos reaccionen a la vista y al tacto.",
    platform: Platform.KODU,
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/e/e0/Kodu_logo.png",
  ...
  {
    id: 6,
    title: "M6: Variables en CodeSpark",
    description: "Aprende a contar puntos y objetos en tu juego.",
    platform: Platform.CODESPARK,
    imageUrl: "https://www.thefoos.com/static/media/foos-app-icon.5c5f850d.png",
  ...
  {
    id: 7,
    title: "M7: Redstone y Energía en Minecraft",
    description: "Circuitos básicos para abrir puertas automáticas.",
    platform: Platform.MINECRAFT,
    imageUrl: "https://education.minecraft.net/wp-content/uploads/minecraft-redstone.jpg",
  ...
  {
    id: 8,
    title: "M8: Mi Libreta Digital en Canvas",
    description: "Diseño gráfico y organización de ideas.",
    platform: Platform.CANVAS,
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Canva_icon_2021.svg/600px-Canva_icon_2021.svg.png",
  ...
  {
    id: 9,
    title: "M9: Caminos y Rutas en Kodu",
    description: "Crea rutas de patrullaje para tus personajes.",
    platform: Platform.KODU,
    imageUrl: "https://www.kodupro.com/wp-content/uploads/2016/06/path-tool.png",
  ...
  {
    id: 10,
    title: "M10: Eventos en CodeSpark",
    description: "Haz que los personajes hablen entre ellos.",
    platform: Platform.CODESPARK,
    imageUrl: "https://codespark.com/static/images/logo.png",
  ...
  {
    id: 11,
    title: "M11: Lógica Condicional en Minecraft",
    description: "Si pasa esto, entonces haz aquello.",
    platform: Platform.MINECRAFT,
    imageUrl: "https://education.minecraft.net/wp-content/uploads/minecraft-agent-builder.png",
  ...
  {
    id: 12,
    title: "M12: Depuración en Kodable",
    description: "Encuentra y arregla los errores en el código.",
    platform: Platform.KODABLE,
    imageUrl: "https://www.kodable.com/static/kodable-smeeborgs.png",
  ...
  {
    id: 13,
    title: "M13: Clonación en Kodu",
    description: "Crea ejércitos de objetos con un solo clic.",
    platform: Platform.KODU,
    imageUrl: "https://www.microsoft.com/en-us/research/wp-content/uploads/2016/06/Kodu_Programming_Screenshot.png",
  ...
  {
    id: 14,
    title: "M14: Ciudadanía Digital en Canvas",
    description: "Reglas para ser un buen explorador en internet.",
    platform: Platform.CANVAS,
    imageUrl: "https://static.canva.com/web/images/8439b51903858cf31163.png",
  ...
  {
    id: 15,
    title: "M15: Colaboración en Minecraft",
    description: "Construye con tus compañeros en un mundo compartido.",
    platform: Platform.MINECRAFT,
    imageUrl: "https://education.minecraft.net/wp-content/uploads/minecraft-edu-classroom.jpg",
  ...
  {
    id: 16,
    title: "M16: Gran Reto Final",
    description: "Demuestra todo lo aprendido en una misión libre.",
    platform: Platform.CANVAS,
    imageUrl: "https://www.canva.com/design/play-video-icon.png",
